import css from './states-map.module.css';
...
const StatesMap = () => {
  ...
  return (
    <svg
      className={cn(css.path)}
      xmlns='http://www.w3.org/2000/svg'
      width='959'
      height='593'
      viewBox='0 0 959 593'>
      <title>Cortina Coverage</title>
      <g className='' fill={`url(${router.pathname}#paint0_linear)`}>
        <path
      ...
      <g className='#D3D3D3'>
        <defs>
          <linearGradient
            ...
            <stop offset='1' stopColor='#03C9E6' />
          </linearGradient>
        </defs>
      </g>
    </svg>
